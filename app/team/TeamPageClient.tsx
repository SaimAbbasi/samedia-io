...
const team = [
  {
    ...
    color: 'bg-lime',
    textColor: 'text-dark',
    bio: "Saim is a Mechanical Engineering graduate from Queen's University and a former XVA, Collateral and Credit Sales Trading Analyst at Scotiabank Capital Markets. He applies the same quantitative, systems-level discipline from institutional finance to every strategy SA Media builds, making the firm structurally different from agencies built by creatives alone. Before founding SA Media, Saim completed three company acquisitions in under two years, culminating in an exit to Asset Entities (NASDAQ: $ASST) and a subsequent transaction with Strive Asset Management. He is currently Managing Partner at Iron Key Capital, one of the youngest individuals to hold that title globally. Saim has served as Chief Technology Officer and Head of AI as well as CMO for Progress Group Inc., and CMO for Squirrel Wallet, Director of Strategy and Operations at Vosyn AI, and sits on the Board of Advisors at CMPUS. His content platforms have accumulated 250M+ views and the SA ecosystem has generated over $10M in collective economic value across 1,000+ founders and students mentored.",
